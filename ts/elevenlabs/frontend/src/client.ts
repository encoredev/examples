// Code generated by the Encore v1.37.7 client generator. DO NOT EDIT.
...
export default class Client {
  public readonly elevenlabs: elevenlabs.ServiceClient;
  ...
  constructor(target: BaseURL, options?: ClientOptions) {
    ...
    this.elevenlabs = new elevenlabs.ServiceClient(base);
...
export namespace elevenlabs {
  ...
  export class ServiceClient {
    ...
    public async generateVoiceAudio(
      ...
      return this.baseClient.callAPI(method, `/generate`, body, options);
    }
    ...
    public async getHistory(): Promise<{
      ...
      const resp = await this.baseClient.callAPI("GET", `/history`);
      return (await resp.json()) as {
        history: History[];
      };
    }

    public async getHistoryItemAudio(
      method: "GET",
      id: string,
      body?: BodyInit,
      options?: CallParameters,
    ...
    public async getVoices(): Promise<{
      voices: Voice[];
    }> {
      // Now make the actual call to the API
      const resp = await this.baseClient.callAPI("GET", `/voices`);
      return (await resp.json()) as {
        voices: Voice[];
      };
    }
