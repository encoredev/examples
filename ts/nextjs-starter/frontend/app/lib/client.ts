...
export namespace frontend {
    ...
    export class ServiceClient {
        ...
        public async nextjs(method: "GET" | "POST" | "PATCH" | "PUT" | "DELETE" | "HEAD" | "OPTIONS" | "TRACE", rest: string[], body?: BodyInit, options?: CallParameters): Promise<Response> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "next-js-test-ts-9wvi-Generated-TS-Client (Encore/v1.36.0)";
        }
