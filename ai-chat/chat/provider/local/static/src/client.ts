  ...
  export class ServiceClient {
    ...
    public async Avatar(
      ...
      return this.baseClient.callAPI(
        method,
        `/bots/${encodeURIComponent(id)}/avatar`,
        body,
        options,
      );
    }
    ...
    public async List(params: ListBotRequest): Promise<Bots> {
      ...
      // Now make the actual call to the API
      const resp = await this.baseClient.callAPI("GET", `/bots`, undefined, {
        query,
      });
...
export namespace chat {
  ...
  export class ServiceClient {
     ...
     */
    public async AddBotToChannel(
      channelID: string,
      botID: string,
    ): Promise<void> {
      await this.baseClient.callAPI(
        "POST",
        `/chat/channels/${encodeURIComponent(
          channelID,
     ...
     */
    public async AddBotToProviderChannel(
      provider: string,
      channelID: string,
      botID: string,
    ): Promise<void> {
      await this.baseClient.callAPI(
        "POST",
        `/chat/provider/${encodeURIComponent(
          provider,
        )}/channels/${encodeURIComponent(channelID)}/bots/${encodeURIComponent(
          botID,
        )}`,
      );
    }
     ...
     */
    public async InstructBotInChannel(
      channelID: string,
      params: InstructRequest,
    ): Promise<void> {
      await this.baseClient.callAPI(
        "POST",
        `/chat/channels/${encodeURIComponent(channelID)}/instruct`,
        JSON.stringify(params),
      );
    }
     ...
     */
    public async InstructBotInProviderChannel(
      provider: string,
      channelID: string,
      params: InstructRequest,
    ): Promise<void> {
      await this.baseClient.callAPI(
        ...
        `/chat/provider/${encodeURIComponent(
          provider,
        )}/channels/${encodeURIComponent(channelID)}/instruct`,
        JSON.stringify(params),
      );
    }
     ...
     */
    public async RemoveBotFromChannel(
      channelID: string,
      botID: string,
    ): Promise<void> {
      await this.baseClient.callAPI(
     ...
     */
    public async RemoveBotFromProviderChannel(
      provider: string,
      channelID: string,
      botID: string,
    ): Promise<void> {
...
export namespace local {
  ...
  export class ServiceClient {
    ...
    public async ServeHTML(
      ...
      return this.baseClient.callAPI(
        method,
        `/${fallback.map(encodeURIComponent).join("/")}`,
        body,
        options,
      );
    }
...
export namespace slack {
  ...
  export class ServiceClient {
     ...
     */
    public async SlackEventHandler(
      params: SlackEvent,
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (typeof window === "undefined") {
      this.headers["User-Agent"] =
        "{{ENCORE_APP_ID}}-Generated-TS-Client (Encore/v1.38.4)";
    }
