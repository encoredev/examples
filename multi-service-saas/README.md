...
A SaaS backend starter built with [Encore.go](https://encore.dev), demonstrating multi-service architecture with event-driven communication.

## Architecture

This app has four services, each with its own database:
