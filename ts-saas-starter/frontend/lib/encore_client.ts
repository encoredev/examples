...
export function Environment(name: string): BaseURL {
    return `https://${name}-saas-template-7ks2.encr.app`
}
...
/**
 * Client is an API client for the saas-template-7ks2 Encore application.
 */
...
export namespace User {
    ...
    export class ServiceClient {
         ...
         */
        public async getProfilePictureUrl(): Promise<{
    imageUrl: string | null
    expiresIn: number | null
}> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/user/profile-picture-url`)
    ...
    expiresIn: number | null
         ...
         */
        public async uploadProfilePicture(method: "POST", body?: BodyInit, options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/user/profile-picture`, body, options)
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "saas-template-7ks2-Generated-TS-Client (Encore/v1.46.5)";
        }
