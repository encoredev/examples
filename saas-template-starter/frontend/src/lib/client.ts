...
export function Environment(name: string): BaseURL {
    return `https://${name}-saas-stater-template-afp2.encr.app`
}
...
/**
 * Client is an API client for the saas-stater-template-afp2 Encore application.
 */
...
export namespace users {
    ...
    export class ServiceClient {
         ...
         * It requires authentication, so the user must be logged in.
         */
        public async updateUser(id: string, params: User): Promise<void> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "saas-stater-template-afp2-Generated-TS-Client (Encore/v1.46.4)";
        }
