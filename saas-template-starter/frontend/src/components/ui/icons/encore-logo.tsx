export function EncoreLogo({ className = 'h-16' }: { className?: string }) {
    return (
        <svg
            className={className}
            version='1.1'
