...
export namespace activity {
    ...
    export class ServiceClient {
        ...
        public async GetActivities(params: FilterActivitiesRequest): Promise<ActivitiesResponse> {
            ...
            const resp = await this.baseClient.callTypedAPI("GET", `/v1/activities`, undefined, {query})
            return await resp.json() as ActivitiesResponse
        }
    }
}
...
export namespace product {
    ...
    export class ServiceClient {
        ...
        public async GetProducts(): Promise<ProductsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/v1/products`)
...
export namespace subscription {
    ...
    export interface FilterSubscriptionsRequest {
        "user_id": string
    }
    ...
    export class ServiceClient {
        ...
        public async CreateCheckoutSession(params: CreateCheckoutSessionRequest): Promise<CreateCheckoutSessionResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/v1/checkout-session`, JSON.stringify(params))
            return await resp.json() as CreateCheckoutSessionResponse
        }

        public async CreateCustomerPortalSession(): Promise<CreateCustomerPortalSessionResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/v1/customer-portal-session`)
            return await resp.json() as CreateCustomerPortalSessionResponse
        }

        public async GetSession(sessionID: string): Promise<SessionResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/v1/session/${encodeURIComponent(sessionID)}`)
            return await resp.json() as SessionResponse
        }

        public async GetSubscriptions(params: FilterSubscriptionsRequest): Promise<SubscriptionsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/v1/subscriptions`, undefined, {query})
            return await resp.json() as SubscriptionsResponse
        }

        public async StripeWebhook(method: string, body?: BodyInit, options?: CallParameters): Promise<globalThis.Response> {
...
export namespace user {
    ...
    export class ServiceClient {
        ...
        public async AddUser(): Promise<UserResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/v1/users`)
            return await resp.json() as UserResponse
        }

        public async GetAllUsers(): Promise<UsersResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/v1/all-users`)
            return await resp.json() as UsersResponse
        }

        public async GetUser(): Promise<UserResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/v1/me`)
            return await resp.json() as UserResponse
        }
        ...
        public async GetUsersByFilter(params: GetUsersByFilterRequest): Promise<UsersResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
        ...
        public async UpdateUser(userID: string, params: UpdateUserRequest): Promise<UserResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("PATCH", `/v1/users/${encodeURIComponent(userID)}`, JSON.stringify(params))
            return await resp.json() as UserResponse
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "{{ENCORE_APP_ID}}-Generated-TS-Client (Encore/v1.46.5)";
        }
