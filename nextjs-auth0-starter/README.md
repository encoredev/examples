...
This is an [Encore.go](https://encore.dev/) + [Next.js](https://nextjs.org/) + [Auth0](https://auth0.com/) project starter. It's a great way to learn how to combine Encore's backend capabilities with a modern web framework and a widely used authentication provider — perfect for building a web app.
