// Code generated by the Encore v1.36.0 client generator. DO NOT EDIT.
...
/**
 * Client is an API client for the speech-ai-tutorial-xqm2 Encore application. 
 */
export default class Client {
    public readonly backend: backend.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.backend = new backend.ServiceClient(base)
...
export namespace backend {
    export interface AssemblyAIWebhookRequest {
        /**
    ...
    export class ServiceClient {
         ...
         */
        public async CreateTranscript(params: CreateTranscriptRequest): Promise<void> {
            await this.baseClient.callAPI("POST", `/api/transcripts`, JSON.stringify(params))
        }

        public async GetTranscript(id: string): Promise<GetTranscriptResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/api/transcripts/${encodeURIComponent(id)}`)
         ...
         */
        public async GetTranscriptions(): Promise<GetTranscriptionsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/api/transcripts`)
            return await resp.json() as GetTranscriptionsResponse
        }
        ...
        public async Upload(method: "POST", body?: BodyInit, options?: CallParameters): Promise<Response> {
            return this.baseClient.callAPI(method, `/api/upload`, body, options)
        }
         ...
         * code.
         */
        public async Webhook(params: AssemblyAIWebhookRequest): Promise<void> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "speech-ai-tutorial-xqm2-Generated-TS-Client (Encore/v1.36.0)";
        }
