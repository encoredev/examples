[![MseeP.ai Security Assessment Badge](https://mseep.net/pr/encoredev-examples-badge.png)](https://mseep.ai/app/encoredev-examples)
...
| [ts/ai-agent-api](ts/ai-agent-api)                               | AI Agent API Backend with Claude                                                                                         | Microservices, APIs, SQL Database, Secrets                             |
| [ts/multi-service-saas](ts/multi-service-saas)                   | Multi-Service SaaS Backend Starter                                                                                       | Microservices, APIs, SQL Database, Pub/Sub                             |
| [ts/webhook-processor](ts/webhook-processor)                     | Webhook Processor with Pub/Sub fan-out                                                                                   | Microservices, APIs, SQL Database, Pub/Sub, Secrets                    |
| [ts/langfuse-openrouter](ts/langfuse-openrouter)                 | LangFuse + OpenRouter AI Starter                                                                                         | APIs, SQL Database, Secrets                                            |
| [ts/daytona](ts/daytona)                                         | Daytona AI Agent Infrastructure Starter                                                                                  | APIs, Secrets                                                          |
| [ts/resend](ts/resend)                                           | Resend Email Integration Example                                                                                         | APIs, Secrets                                                          |
| [ts/betterauth](ts/betterauth)                                   | BetterAuth Authentication Example                                                                                        | APIs, Auth, SQL Database                                               |
| [ts/autumn](ts/autumn)                                           | Autumn Billing Integration Example                                                                                       | APIs, Secrets                                                          |
| [ts/polar](ts/polar)                                             | Polar Payment Integration Example                                                                                        | APIs, Secrets                                                          |
| [ts/polar-file-sharing](ts/polar-file-sharing)                   | Polar File Sharing Example                                                                                               | APIs, Secrets                                                          |
| [ts/clerk-simple](ts/clerk-simple)                               | Simple Clerk Authentication Example                                                                                      | APIs, Auth                                                             |
| [ts/replicate-image-generator](ts/replicate-image-generator)     | Replicate Image Generator Example                                                                                        | APIs, Secrets                                                          |
| [ts/socket-io](ts/socket-io)                                     | Socket.IO Real-time Communication Example                                                                                | APIs, Raw Endpoints                                                    |
| [ts/inbound](ts/inbound)                                         | Inbound Webhook Handler Example                                                                                          | APIs, Raw Endpoints                                                    |
...
| [clerk-remix](clerk-remix)                 | Clerk + Remix Authentication Example                                                                                                | APIs, Auth, Frontend                                                                        |
| [websocket-echo-server](websocket-echo-server) | WebSocket Echo Server Example                                                                                                  | APIs, Raw Endpoints                                                                         |
