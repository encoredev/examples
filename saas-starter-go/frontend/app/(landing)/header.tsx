                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      <Link href="/features#feature-1"   >
                        ...
                        <p className="text-sm text-muted-foreground leading-snug">Get paid easily</p>
                      </Link>
                    </NavigationMenuLink>
                  </li>
                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      <Link href="/features#feature-2">
                        ...
                        <p className="text-sm text-muted-foreground leading-snug">Auth is already setup</p>
                      </Link>
                    </NavigationMenuLink>
                  </li>
                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      <Link href="/features#feature-3" >
                        ...
                        <p className="text-sm text-muted-foreground leading-snug">Uses shadcn/ui for components</p>
                      </Link>
                    </NavigationMenuLink>
                  </li>
                </ul>
